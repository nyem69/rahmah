...
<nav>
	<div style="display:flex; flex-wrap:nowrap;width:100vw">
		<svg style="flex:1 1 auto;" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100vw 10vh" height="10vh">
			<g transform="translate(0,0)" style="cursor:pointer">


				<rect x="0" y="0" width="1e6" height="1e6" fill="crimson" stroke="#999"
...
<div style="width:100vw;height:80vh" bind:this={mapElement}></div>
