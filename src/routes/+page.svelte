	...
	<div style="display:flex; flex-wrap:nowrap;width:100vw">
		<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 200 30" style="flex:1 1 auto;height:10vh;border:2px outset #999;" >
			<g transform="translate(0,0)" style="cursor:pointer">
				...
				<rect x="-200" y="-200" width="1e6" height="1e6" fill="crimson" stroke="#999"
			...
			<g transform="translate(0,0)" style="cursor:pointer">
				...
				<g transform="translate(10,0)" pointer-events="none">
					<svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-circle-plus"
						style="margin-right:6px;"
						width="40" height="100%" viewBox="0 0 24 24" stroke-width="2" stroke="#ffffff" fill="none" stroke-linecap="round" stroke-linejoin="round">
					<path stroke="none" d="M0 0h24v24H0z" fill="none"/>
					<circle cx="12" cy="12" r="9" />
